...
public class MoreLikeThisQuery extends Query {
    ...
    public Query rewrite(IndexReader reader) throws IOException {
        ...
        mlt.setMaxQueryTermsPerField(maxQueryTerms);
        mlt.setStopWords(stopWords);
        MLTResult mltResult = mlt.like(new String[]{fieldName}, new StringReader(likeText));
        BooleanQuery bq = (BooleanQuery)mltResult.rawMLTQuery;
    ...
    */
    ...
    public String toString(String field) {
        return "queryFromDocuments:" + likeText;
    }
